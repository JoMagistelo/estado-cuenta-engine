...
from parsers.mifel.extractors.datos import extract_datos_cuenta_words


ROOT = Path(__file__).resolve().parents[3]

PDF_PATH = ROOT / "data" / "12 Debito Mifel_May26_OOMM851003HJCRLR08.pdf"
...
def main():
    ...
    print()
    print("=" * 60)
    print("PRUEBA PARSER DATOS CUENTA MIFEL (WORDS)")
    print("=" * 60)
